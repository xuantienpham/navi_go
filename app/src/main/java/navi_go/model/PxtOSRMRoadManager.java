 ...
 * It uses OSRM, a free open source routing service based on OpenStreetMap data. <br>
 *
...
public class PxtOSRMRoadManager extends RoadManager {
    ...
    public static final String MEAN_BY_BIKE = "route/v1/bike/";
    public static final String MEAN_BY_FOOT = "route/v1/foot/";
