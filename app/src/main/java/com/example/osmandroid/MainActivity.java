...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout rlMain = findViewById(R.id.main);
        //rlMain.addView(miniMap);

        mMapView.draw(null);

        RelativeLayout m = new RelativeLayout(null) {
        ...
        // TODO
        //RelativeLayout relativeLayout = findViewById(R.id.control);
